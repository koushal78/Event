   ...
   <Nav/> 
    <div className="bg-gradient-to-top h-[calc(100vh-72px)] flex justify-center items-center lg:gap-[150px] gap[100px] lg:px-[0px] px-[50px] ">
      <div className=' shadow-2xl shadow-indigo-600 lg:w-[500px] flex flex-col items-center  pr-4 border-2 border-indigo-600 w-[300px] rounded-lg lg:h-[400px] '>
        <h1 className='block text-center font-medium text-indigo-900 text-4xl my-4'>Registration</h1>
        <div className='flex flex-col gap-5 md:w-[300px] lg:gap-10  justify-center items-center  my-3 '>
          <input className='bg-transparent lg:w-[400px] text-xl text-indigo-800 placeholder:text-indigo-400 pl-4  w-[200px] md:w-[250px] border-b-2 border-indigo-600 outline-none' type="text" placeholder='Enter your Name ' />
          ...
          <p className='text-white'>Already have an account? <Link className='text-indigo-600' to="/Login">Login Now</Link></p>
      </div>
